...
Get the `django_messaging-0.20.0-py3-none-any.whl` package from [Gumroad](https://websightful.gumroad.com/l/django-messaging).
...
```bash
cp /path/to/django_messaging-0.20.0-py3-none-any.whl private_wheels/
```
...
file:./private_wheels/django_messaging-0.20.0-py3-none-any.whl
```
...
```bash
pip install /path/to/django_messaging-0.20.0-py3-none-any.whl
```
